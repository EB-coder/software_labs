...
namespace Lab8
{
    public partial class Form1 : Form
    {
        ...
        private void ButtonWhichAreSelected_Click(object sender, EventArgs e)
        {
        ...
        private void ButtonSelectProgrammatically_Click(object sender, EventArgs e)
        {
        ...
        private void RButtonWhichAreSelected_Click(object sender, EventArgs e)
        {
        ...
        private void SelectRbuttonProgrammatically_Click(object sender, EventArgs e)
        {
        ...
        private void WhichAreSelected_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked == true)
                MessageBox.Show("The radioButton1 item is selected");
            if (radioButton2.Checked == true)
        ...
        private void EventCheckedChangedR_CheckedChanged(object sender, EventArgs e)
        {
            MessageBox.Show("The CheckedChanged event has occurred");
        }
    }
