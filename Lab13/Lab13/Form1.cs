...
namespace Lab13
{
    public partial class Form1 : Form
    {
        int index = 0;
        int[] sum = { 2, 1, 1, 1, 2 };
        string[] s = { " C# is? ", " What is an int? ", " What is the foreach operator responsible for? ", " How does the conditional if statement work? ", " How does an int differ from a short data type? " }; // an array with the questions
